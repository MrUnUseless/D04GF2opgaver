...
{
    class HjemmeOpgaveWorkshoppenCB_Piller
    {
        public static void OpgaveRun()
        {
            ...
            //Calls main Menu
            HjemmeOpgaveWorkshoppen.HovedMenu();
            ...
            do
            {
                ...
                if (hmvalg == "o")
                {
                    HjemmeOpgaveWorkshoppen.GeometriMenu();
                }

                //
                else if (hmvalg == "t")
                {
                    HjemmeOpgaveWorkshoppen.TabelMenu();
                }

                //
                else if (hmvalg == "a")
                {
                    HjemmeOpgaveWorkshoppen.AfslutMenu();
                }
        ...
        public static void GeometriMenu()
        {
            ...
            do
            {
                ...
                Console.WriteLine("\nReturnere til hovedmenu (tryk h)");
                ...
                if (gmvalg == "t")
                {
                    HjemmeOpgaveWorkshoppen.TrekantsBeregning();
                }

                //
                else if (gmvalg == "f")
                {
                    HjemmeOpgaveWorkshoppen.FirkantsBeregning();
                }

                //
                else if (gmvalg == "c")
                {
                    HjemmeOpgaveWorkshoppen.CirkelBeregning();
                }
                ...
                {
                    Console.WriteLine("Din indtastning kunne ikke læses. Prøv igen og brug venligst kun t, f, c, h eller a og afslut med tryk på enter eller return.");
                    Console.WriteLine("Tryk en tast for at prøve igen!");
                    Console.ReadKey();
                }


            } while (gmvalg != "t" && gmvalg != "f" && gmvalg != "c" && gmvalg != "h" && gmvalg != "a");
        }
        ...
        public static void TrekantsBeregning()
        {
            ...
            do
            {
                ...
                Console.WriteLine($"\nArealet af trekanten er {areal} cm².");
        ...
        public static void FirkantsBeregning()
        {
            ...
            do
            {
                ...
                //Writes "TEXT" in terminal at current cursor position and changes to next terminal line after finishing the code line. The variable areal is the result of the calculation and is called by "$" and {}
                Console.WriteLine($"\nArealet af firkanten er {areal} cm².");
        ...
        public static void TabelMenu()
        {
            ...
            do
            {
                ...
                if (tmvalg == "t")
                {
                    HjemmeOpgaveWorkshoppen.TabelVisning();
                }
                ...
                {
                    Console.WriteLine("Din indtastning kunne ikke læses. Prøv igen og brug venligst kun t, h eller a og afslut med tryk på enter eller return.");
                    Console.WriteLine("Tryk en tast for at prøve igen!");
                    Console.ReadKey();
                }

            } while (tmvalg != "t" && tmvalg != "h" && tmvalg != "a");
        }
